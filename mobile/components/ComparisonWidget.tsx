...
const s = StyleSheet.create({
  ...
  bandLabel: { fontSize: 12, color: Colors.primaryLight, textTransform: 'uppercase', letterSpacing: 0.8 },
  bandDate: { fontSize: 14, fontWeight: '600', color: Colors.text, marginTop: 2 },
  vs: { paddingHorizontal: 10, color: Colors.textSubtle, fontSize: 14 },
  metricsRow: { flexDirection: 'row', gap: 12 },
  metricCell: { flex: 1 },
  metricLabel: { fontSize: 12, color: Colors.textSubtle, textTransform: 'uppercase', letterSpacing: 0.8, marginBottom: 4 },
