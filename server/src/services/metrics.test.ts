...
function seedDb(db: Database.Database) {
  ...
  db.prepare(`INSERT INTO issues (id, title, description, status, assignee_id, talla, talla_confidence, created_at, updated_at, synced_at, last_transition_at, talla_updated_at) VALUES ('OPS-1','Fix login','desc','Done','u1','M',0.9,'2026-05-01T00:00:00Z','2026-05-04T00:00:00Z','2026-06-01T00:00:00Z','2026-05-04T00:00:00Z',NULL)`).run();
  ...
  db.prepare(`INSERT INTO issues (id, title, description, status, assignee_id, talla, talla_confidence, created_at, updated_at, synced_at, last_transition_at, talla_updated_at) VALUES ('OPS-2','Deploy infra','desc','Done','u2','L',0.85,'2026-05-01T00:00:00Z','2026-05-08T00:00:00Z','2026-06-01T00:00:00Z','2026-05-08T00:00:00Z',NULL)`).run();
  ...
  db.prepare(`INSERT INTO issues (id, title, description, status, assignee_id, talla, talla_confidence, created_at, updated_at, synced_at, last_transition_at, talla_updated_at) VALUES ('OPS-3','Update config','desc','In Progress','u1','S',0.95,'2026-05-20T00:00:00Z','2026-05-20T00:00:00Z','2026-06-01T00:00:00Z','2026-05-20T00:00:00Z',NULL)`).run();
